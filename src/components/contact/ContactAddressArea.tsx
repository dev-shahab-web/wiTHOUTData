                    ...
                    <div className="row gy-24">
                        {
                            contactData && contactData.map(item => <div key={item.id} className="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                                <div className="contact-box">
                                    <div className="contact-icon mb-30"><i className={item?.icon}></i></div>
                                    <h5 className="contact-title mb-15">{item.title}</h5>
                                    <div className="contact-content">
                                        <Link href="tel:+918429812424">{item.subTitleOne}</Link>
                                        <Link href="tel:+918429962424">{item.subTitleTwo}</Link>
                                    </div>
                                </div>
                            </div>)
                        }
