          ...
          <div className="col-xxl-12 col-xl-12 col-lg-12">
            <div className="product-information-tab">
              ...
              <div className="tab-content" id="pills-tabContent">
                ...
                >
                  <div className="information-wrapper">
                    <div className="information-material mb-20">
                      ...
                      <p>
                        Made from premium cotton fabric, HolyNepalYatra Short Sleeve
                    ...
                    <div className="information-design mb-20">
                      ...
                      <p>
                        ...
                        HolyNepalYatra T-shirts boast a timeless silhouette suitable
                    ...
                    <div className="information-durability mb-20">
                      ...
                      <p>
                        Built to last, HolyNepalYatra Short Sleeve T-shirts undergo
                    ...
                    <div className="information-versatility mb-20">
                      ...
                      <p>
                        ...
                        dressing down for a relaxed day at home, HolyNepalYatra
                    ...
                    <div className="information-instructions mb-20">
                      ...
                      <p>
                        To maintain the quality and appearance of your HolyNepalYatra
                    ...
                    <div className="information-sustainability">
                      ...
                      <p>
                        At HolyNepalYatra, we prioritize sustainability and ethical
                ...
                >
                  <h5 className="mb-20">
                    HolyNepalYatra Short Sleeve T-Shirt Specifications
                  </h5>
