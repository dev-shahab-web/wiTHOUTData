                        ...
                        <div className="col-xl-10">
                            <div className="policy-wrapper p-relative z-index-1">
                                <div className="policy-item">
                                    ...
                                    <p>Welcome to HolyNepalYatra. These Terms and Conditions govern your use of our website. By accessing
                                ...
                                <div className="policy-item">
                                    ...
                                    <p>In no event shall HolyNepalYatra INC, nor its directors, employees, partners, agents, suppliers, or
